...
public class Hydra implements IHydra{
    ...
    public boolean run(String ip_address, String dictionary, String port, String username) throws IOException, InterruptedException {
        ...
        String hydra_command = "hydra -o " + provider.getFilePath(new File("hydra_output.json")) + " -b json -s " + port + " -l " + username + " -P " + provider.getFilePath(new File("dictionary.txt")) + " " + ip_address + " ftp";
        ...
        Thread.sleep(20000);
        converter.toXmlfile(provider.getFilePath(new File("hydra_output.json")));
        return true;
    }
